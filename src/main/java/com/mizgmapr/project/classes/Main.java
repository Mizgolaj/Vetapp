...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (SessionFactory sessionFactory = new Configuration()
            ...
            firstVet.ratingCalculator(5);firstVet.ratingCalculator(3);
            firstVet.ratingCalculator(5);firstVet.ratingCalculator(4);
            ...
            secondVet.ratingCalculator(1);firstVet.ratingCalculator(5);
            secondVet.ratingCalculator(6);firstVet.ratingCalculator(3);
            ...
            thirdVet.ratingCalculator(5);thirdVet.ratingCalculator(6);
            thirdVet.ratingCalculator(5);thirdVet.ratingCalculator(5);
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                session.save(firstVet);session.save(secondVet);session.save(thirdVet);
